...
import { Order, Mode, float32ndarray } from '@stdlib/types/ndarray';
...
interface Float32Vector {
	...
	* // returns 0
	*/
	new ( options?: Options ): float32ndarray;
	...
	* var numel = require( '@stdlib/ndarray-numel' );
	*
	* var arr = new Float32Vector( 2 );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 2
	*/
	new ( length: number, options?: Options ): float32ndarray;
	...
	* var numel = require( '@stdlib/ndarray-numel' );
	*
	* var arr = new Float32Vector( [ 1.0, 2.0 ] );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 2
	*/
	new ( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): float32ndarray;
	...
	* // returns 8
	*/
	new ( buffer: ArrayBuffer, options?: Options ): float32ndarray;
	...
	* // returns 6
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, options?: Options ): float32ndarray;
	...
	* // returns 2
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, length: number, options?: Options ): float32ndarray;
	...
	* // returns 0
	*/
	( options?: Options ): float32ndarray;
	...
	* // returns 2
	*/
	( length: number, options?: Options ): float32ndarray;
	...
	* // returns 2
	*/
	( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): float32ndarray;
	...
	* // returns 8
	*/
	( buffer: ArrayBuffer, options?: Options ): float32ndarray;
	...
	* // returns 6
	*/
	( buffer: ArrayBuffer, byteOffset: number, options?: Options ): float32ndarray;
	...
	* // returns 2
	*/
	( buffer: ArrayBuffer, byteOffset: number, length: number, options?: Options ): float32ndarray;
}
...
* // returns 2
*/
declare var ctor: Float32Vector;
